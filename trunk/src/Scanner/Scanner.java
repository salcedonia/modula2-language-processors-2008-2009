...
package Scanner;
import Scanner.atributo.Puntuacion;
import TablaDeSimbolos.*;
import GestorDeErrores.*;
import Scanner.atributo.Cadena;
import Scanner.atributo.Caracter;
import Scanner.atributo.Entero;
import Scanner.atributo.Literal;
import Scanner.atributo.Operador;
import Scanner.atributo.Real;
...
private Token creaToken(TipoToken tipo, Object valor) {
        ...
        switch (tipo){
            ...
            case FUNCION_PREDEFINIDA:
                return new Token(TipoToken.FUNCION_PREDEFINIDA, yyline, yycolumn, new Literal((String) valor));
            case IDENTIFICADOR:
              ...
              // TODO: inventar algo para las funciones predefinidas
//              try{     
//                return new Token(TipoToken.FUNCION_PREDEFINIDA, yyline, yycolumn, new Literal((String)FuncionesPredefinidas.valueOf((String)value));           
//              }
//              catch (Exception e) {      
//              }
//              
//              try{
//                  return new Token(TipoToken.PROCEDIMIENTO_PREDEFINIDO, yyline, yycolumn, new Literal((String) valor));
//              }
//              catch (Exception e2){
//                 
//              }
            ...
            case PROCEDIMIENTO_PREDEFINIDO:
                return new Token(TipoToken.PROCEDIMIENTO_PREDEFINIDO, yyline, yycolumn, new Literal((String) valor));
            case PUNTUACION:
                return new Token(TipoToken.PUNTUACION, yyline, yycolumn,new Puntuacion( (TipoPuntuacion) valor));   
        }
        return null;
}
