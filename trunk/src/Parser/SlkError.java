...
import GestorDeErrores.ErroresSintacticos;
import GestorDeErrores.GestorErrores;
import GestorDeErrores.TErrorSintactico;

//***************************************************************************//
/**
 * Clase que gestiona los errores cometidos durante el an�lisis sint�ctico 
...
//	***************************************************************************//
	 ...
	 * 
	 * @param tokens Tokens le�dos por el Scanner.
...
//	***************************************************************************//
	...
	public void input_left (){
		...
		String error =  "La pila del parser ha quedado vac�a " +
						"pero todav�a quedan por analizar.";
